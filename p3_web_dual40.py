...
<style>.workspace,.main-column,.side-column{min-width:0}.table-wrap{max-width:100%}.asset-pnl-panel{grid-column:1/-1;margin-top:2px;background:var(--surface);border:1px solid var(--line);border-radius:6px;padding:10px 11px}.asset-pnl-title{font-size:11px;font-weight:800;color:var(--mut);text-transform:uppercase;margin-bottom:8px}.asset-pnl-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:7px}.asset-pnl-row{display:grid;grid-template-columns:36px minmax(64px,1fr);gap:2px 8px;align-items:center;padding:8px;border:1px solid var(--line-soft);border-radius:5px;background:#0f1318}.asset-pnl-row b{font-size:13px}.asset-pnl-row span{font-size:11px;color:var(--mut);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.asset-pnl-row span:nth-child(2){font-weight:900;font-size:14px}@media(max-width:680px){.mobile-optional{display:none}.primary-table{min-width:0;table-layout:fixed}.primary-table th,.primary-table td{padding:7px 6px}.primary-table th:nth-child(1){width:19%}.primary-table th:nth-child(2){width:18%}.primary-table th:nth-child(3){width:39%}.primary-table th:nth-child(6){width:24%}.cell-code{max-width:120px}.asset-pnl-grid{grid-template-columns:1fr}}</style>
<header class="topbar"><div class="brand"><div class="brand-mark">D40</div><div class="brand-copy"><h1>DUAL40 Operasyon</h1><span>40¢ + 40¢ · PAPER LIMIT / LIVE POST-ONLY</span></div></div><div class="header-state"><span id="modepill" class="pill">DRY</span><span id="state" class="mut">Yükleniyor…</span><span class="mut operator">__P3_OPERATOR__</span><button class="logout" onclick="logoutNow()">Çıkış</button></div></header><main class="wrap">
<div id="notice" class="notice"><b>DRY / PAPER.</b> Fiyat-geçmişi rejim kontrolleri girişe engel değildir. Ask 40¢ ya da altındaysa ilgili sanal bacak kayıtlı ask fiyatından tam dolar; tek bacak resmi market sonucuyla kapatılır.</div>
...
<section class="section"><div class="section-head"><div><h3>P2.6 Araştırma Audit</h3><p>DUAL40 girişinden bağımsız model deneyi</p></div></div><div class="grid" id="p26metrics"></div></section>
