...
<div id="notice" class="notice"><b>DRY / PAPER.</b> BTC/ETH/SOL/XRP PAPER lane'leri bağımsız 5 → 10 → 30 recovery kullanır; LIVE varsayılan paralellik 1 kalır. Ekranda 41¢ görünmesi, 40¢ emrin dolduğunun kanıtı değildir: paper yalnız gerçek best ask ≤40¢ olduğunda fill sayar; LIVE yalnız token bakiye artışıyla fill doğrular.</div>
...
<div class="box"><h2>Gate Kohortları</h2><div class="grid" id="cohorts"></div></div>
<div class="box"><h2>P2.6 Tahmin Paper Readiness</h2><div class="grid" id="p26metrics"></div><div class="scroll"><table><thead><tr><th>Market</th><th>Aşama</th><th>Decision</th><th>Reason</th><th>Would Open</th><th>Observed</th></tr></thead><tbody id="p26decisions"></tbody></table></div></div>
<div class="box"><h2>Aktif Cycle'lar</h2><pre id="active" class="liveout mono">Yok</pre></div>
<div class="box"><h2>Stabilite Taraması</h2><div class="grid" id="scanmetrics"></div><div class="scroll"><table><thead><tr><th>Market</th><th>Uygun</th><th>Neden</th><th>Seviye</th><th>Skor</th><th>Stabil</th><th>TTE</th><th>UP Mid</th><th>DOWN Mid</th><th>Rolling Range</th><th>Rolling Drift</th><th>Opening Reason</th><th>Opening Range</th><th>Opening Drift</th><th>Opening One-way</th><th>40¢ Queue Ratio</th><th>Depth Ratio</th><th>Forecast</th><th>Gate Modları</th><th>Lane</th><th>Decision</th><th>Aktif Cycle</th></tr></thead><tbody id="candidates"></tbody></table></div></div>
<div class="box"><h2>Market Karar Günlüğü</h2><div class="scroll"><table><thead><tr><th>Asset</th><th>Condition</th><th>Decision</th><th>Reason</th><th>Opening</th><th>Forecast</th><th>Seen</th><th>Cycle ID</th></tr></thead><tbody id="decisions"></tbody></table></div></div>
<div class="box"><h2>DUAL40 Cycle Günlüğü</h2><div class="scroll"><table><thead><tr><th>ID</th><th>Scope</th><th>Asset</th><th>Market</th><th>Durum</th><th>Seviye</th><th>Hedef</th><th>UP Fill</th><th>DOWN Fill</th><th>Matched</th><th>Residual</th><th>Sonuç</th><th>PnL</th><th>Pool Sonrası</th><th>41¢ Touch</th><th>Hata</th></tr></thead><tbody id="cycles"></tbody></table></div></div>
</div><script>
