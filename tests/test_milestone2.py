...
def test_transition_rising():
    ...
    engine = TransitionEngine(); engine.pm = MockPM()
...
def test_stability_modifier():
    history = [{"score": 0.8, "date": "2026-04-10"}, {"score": 0.81, "date": "2026-04-11"}, {"score": 0.79, "date": "2026-04-12"}]
    scorer = WalletQualityScorer(history=history)
    assert scorer._calc_stability_modifier() > 0
    volatile_history = [{"score": 0.8, "date": "2026-04-10"}, {"score": 0.2, "date": "2026-04-11"}, {"score": 0.9, "date": "2026-04-12"}]
