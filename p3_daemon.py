...
Runs the model-free complete-set scanner, opportunity lifetime tracker, delayed
FOK/legging replay and optional read-only dashboard.  It never signs or submits
orders.
"""
